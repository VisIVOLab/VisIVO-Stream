...
from app.models.dataset import DatasetLoadResponse, DatasetMetadata, DatasetRecord
...
class DatasetCatalog:
    ...
    def __init__(self, base_dir: Path, runtime_upload_dir: Path, max_upload_size_mb: int) -> None:
